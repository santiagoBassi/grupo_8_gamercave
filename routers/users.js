...
router.get('/:id/changepassword', loggedInMiddlware,usersControllers.showChangePassword)
router.put('/:id/changepassword',loggedInMiddlware, usersControllers.changePassword)
